...
public:
   ...
   const char* genREADME()
   {
      ...
      s += snprintf(s, end_s - s, "Program  : PiMPLE (%s)\n", HW_DESCR);
      s += snprintf(s, end_s - s, "Author   : Copyright (c) 2024 John D. Haughton\n");
...
private:
   ...
   const char* index_html =
      "<html>"
         "<head>"
            "<meta http-equiv=\"refresh\" content=\"0;URL='https://github.com/AnotherJohnH/PiMPLE'\"/>"
         "</head>"
         "<body>"
            "Redirecting to <a href='https://github.com/AnotherJohnH/PiMPLE'>github.com</a>"
         "</body>"
      "</html>";
};
